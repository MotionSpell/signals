...
struct MyOutput : ModuleS {
  void processOne(Data) override { ++frameCount; }
  int frameCount = 0;
};
...
unittest("dasher: timing computation") {
  ...
  struct MyUtcClock : IUtcClock {
    Fraction getTime() { return Fraction(1789, 1); }
  };
  MyUtcClock utcClock;
  ...
  auto expectedMpd =
        format("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
               "<MPD xmlns=\"urn:mpeg:dash:schema:mpd:2011\" type=\"dynamic\" id=\"id\" "
               "profiles=\"urn:mpeg:dash:profile:isoff-live:2011, http://dashif.org/guidelines/dash264\" "
               "availabilityStartTime=\"1970-01-01T00:00:03Z\" publishTime=\"1970-01-01T00:29:49Z\" "
               "minBufferTime=\"PT00H00M0.001S\" minimumUpdatePeriod=\"PT00H00M3.000S\">\n"
               "  <ProgramInformation moreInformationURL=\"http://signals.motionspell.com\">\n"
               ...
               "        <SegmentTemplate media=\"v_0_0x0/v_0_0x0-$Number$.m4s\" "
               "initialization=\"v_0_0x0/v_0_0x0-init.mp4\" startNumber=\"0\"/>\n"
               "      </Representation>\n"
               "    </AdaptationSet>\n"
               "  </Period>\n"
               "</MPD>\n",
...
unittest("dasher: multiple languages") {
  ...
  auto expectedMpd =
        format("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
               ...
               "        <SegmentTemplate media=\"v_1_0x0/v_1_0x0-$Number$.m4s\" "
               "initialization=\"v_1_0x0/v_1_0x0-init.mp4\" startNumber=\"0\"/>\n"
               "      </Representation>\n"
               "    </AdaptationSet>\n"
               "  </Period>\n"
               "</MPD>\n",
...
unittest("dasher: multi-period folders") {
  ...
  auto expectedMpd =
        format("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
               "<MPD xmlns=\"urn:mpeg:dash:schema:mpd:2011\" type=\"static\" id=\"id\" "
               "profiles=\"urn:mpeg:dash:profile:isoff-live:2011, http://dashif.org/guidelines/dash264\" "
               "publishTime=\"1970-01-01T00:29:49Z\" minBufferTime=\"PT00H00M0.001S\" "
               "mediaPresentationDuration=\"PT00H00M6.000S\">\n"
               "  <ProgramInformation moreInformationURL=\"http://signals.motionspell.com\">\n"
               "    <Copyright>Generated by Signals/%s</Copyright>\n"
               "  </ProgramInformation>\n"
               ...
               "      <SegmentTemplate timescale=\"1000\" duration=\"%s\" startNumber=\"0\"/>\n"
               "      <Representation id=\"0\" bandwidth=\"0\" mimeType=\"\" codecs=\"\" startWithSAP=\"1\">\n"
               "        <SegmentTemplate media=\"1970_01_01_00_00_00/v_0_0x0/v_0_0x0-$Number$.m4s\" "
               "initialization=\"v_0_0x0/v_0_0x0-init.mp4\" startNumber=\"0\"/>\n"
               "      </Representation>\n"
               "    </AdaptationSet>\n"
               "  </Period>\n"
               ...
               "      <Representation id=\"0\" bandwidth=\"0\" mimeType=\"\" codecs=\"\" startWithSAP=\"1\">\n"
               "        <SegmentTemplate media=\"1970_01_01_00_00_03/v_0_0x0/v_0_0x0-$Number$.m4s\" "
               "initialization=\"v_0_0x0/v_0_0x0-init.mp4\" startNumber=\"1\" presentationTimeOffset=\"3000\"/>\n"
               "      </Representation>\n"
               "    </AdaptationSet>\n"
               "  </Period>\n"
               "</MPD>\n",
  ...
  std::vector<std::string> expectedFilenames{"1970_01_01_00_00_00/v_0_0x0/v_0_0x0-0.m4s",
        "1970_01_01_00_00_03/v_0_0x0/v_0_0x0-1.m4s", "1970_01_01_00_00_03/v_0_0x0/v_0_0x0-1.m4s",
        "1970_01_01_00_00_03/v_0_0x0/v_0_0x0-1.m4s", "1970_01_01_00_00_03/v_0_0x0/v_0_0x0-1.m4s"};
...
unittest("dasher: tiles") {
  ...
  auto expectedMpd =
        format("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
               ...
               "        <SegmentTemplate media=\"v_2_0x0/v_2_0x0-$Number$.m4s\" "
               "initialization=\"v_2_0x0/v_2_0x0-init.mp4\" startNumber=\"0\"/>\n"
               "      </Representation>\n"
               "    </AdaptationSet>\n"
               "  </Period>\n"
               "</MPD>\n",
